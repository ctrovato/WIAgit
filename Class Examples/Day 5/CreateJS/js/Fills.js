window.onload = function() {
	...
	//Basic fill
	 ...
	 rect2.graphics.beginFill(createjs.Graphics.getRGB(162,216,255, .5));
	 //HSl
	 ...
	 rect2.graphics.beginLinearGradientFill(["yellow", "red"], [0,1], 50,50, 150, 150);
	 ...
	 //Horizontal
	  ...
	  //Vertical
	   ...
	   rect2.graphics.beginLinearGradientFill(["yellow", "green"], [0,1], 100,100, 150, 150);
	 ...
	 rect2.graphics.rect(100,100, 200, 200);
